...
{
	JLabel userLabel,namelabel, passLabel, phoneLabel,addressLabel;
	JTextField userTF,nameTF, passTF, phoneTF1,phoneTF2, addressTF;
	...
	public Signup(String userId)
	{
		...
		userLabel.setBounds(150, 150, 120, 30);
		panel.add(userLabel);
	...
	public void insertIntoDB()
	{
		...
		String query1 = "INSERT INTO customer VALUES ('"+userId+"','"+password+"','"+phoneNumber+"','"+address+"');";
